...
//TODO:Распилить сервис по функциональностям. 
//TODO:Починить рисование полигона на мобильных, когда тап+драндроп плохо отрабатывают при наличии скролла. 
//TODO:Починить фильтрацию типов для фильтров, сейчас "нужные типы" фильруются только из состава отфильтрованных точек, что не верно
//TODO:Починить конфликтные изменения. Всё равно удавалось попасть в эту ситуацию и терялись изменения
//TODO:Сделать режим ридонли для маршрута, чтобы никто случайно его не ломал
//TODO:Перевести на яндекс карты
//TODO:Адаптироваться к тёмной теме
//TODO:Перевести типы на русский, сгруппировать их по смыслу
//TODO:Добавить страндартных фильтров (дорога, улица\не улица)
//TODO:Сделать разрыв в маршруте, чтобы планировать было удобнее
